# -*- coding: utf-8 -*-
"""
Created on Thu Oct 29 14:20:26 2020
...
# wdd_par.subspace_completion = False

# print('Reconstructing...')


# obj_r = wdd.Wigner_2D(b_n, wdd_par, obj)
...
# obj_r = util.align_objects(obj,obj_r,mask)
# show_object(obj_r)

# f_r = forward.forward_2D_pty(obj_r,par)
# b_r = forward.forward_to_meas_2D_pty(f_r)
# # print('Mesurements from reconstructed object:')
# # # show_measurements(b_r,locations_2d,shift)
# # # print('Absolute pixelwise error:')
# # # show_measurements(np.abs(b-b_r),locations_2d,shift)
...
# print('Reconstruction:')
# print( 'Relative error: ', util.relative_error(obj,obj_r,mask) )
# print( 'Relative measurement error: ', util.relative_measurement_error(b_n,b_r))
